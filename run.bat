...
echo "Do you want to deploy the contract? (y/n), you need 5 NEAR in your master account."
read answer
...
near create-account $TOKEN_ADDRESS_PREFIX.$MASTER_ACCOUNT --masterAccount $MASTER_ACCOUNT --initialBalance 5
